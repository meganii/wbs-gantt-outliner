  ...
  return (
    <div className="bg-white text-gray-900 overflow-x-auto">
      <div className="h-[40px] sticky top-0 bg-gray-100 border-b border-gray-300 flex items-center px-4 font-bold text-xs z-10 w-min min-w-full">
        ...
        {showDetails && (
          <>
            <div className="w-64 px-2 border-l border-gray-300 h-full flex items-center flex-shrink-0">Description</div>
            <div className="w-32 px-2 border-l border-gray-300 h-full flex items-center flex-shrink-0">Assignee</div>
            <div className="w-48 px-2 border-l border-gray-300 h-full flex items-center flex-shrink-0">Deliverables</div>
          </>
        )}
